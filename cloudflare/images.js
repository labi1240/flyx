...
var define_IMAGES_DEVICE_SIZES_default = [640, 750, 1080, 1920];

// <define:__IMAGES_FORMATS__>
var define_IMAGES_FORMATS_default = ["image/avif", "image/webp"];

// <define:__IMAGES_IMAGE_SIZES__>
var define_IMAGES_IMAGE_SIZES_default = [16, 32, 64, 128, 256];
...
var define_IMAGES_REMOTE_PATTERNS_default = [{ protocol: "https", hostname: "^(?:^(?:image\\.tmdb\\.org)$)$", port: "", pathname: "^(?:\\/t\\/p(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$" }];
